...
class ImageFolder(Dataset):
    def __init__(self, path,  split_file=None, split_key=None, first_k=None, size=None,
        ...
        if split_file is None:
            filenames = sorted(os.listdir(path), key=numerical_sort)
        else:
...
class PairedImageFolders(Dataset):
    ...
    def __init__(self, root_path_1, **kwargs): # root_path_2,
        self.dataset_1 = ImageFolder(root_path_1, **kwargs)
        self.file_names = self.dataset_1.files
    ...
    def __getitem__(self, idx):
        return self.dataset_1[idx],self.file_names[idx] #self.dataset_2[idx]
